...
https://github.com/brianmhess/cassandra-loader/releases/download/v0.0.5/cassandra-loader

Get it with wget:
```
wget https://github.com/brianmhess/cassandra-loader/releases/download/v0.0.5/cassandra-loader
```

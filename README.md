...
https://github.com/brianmhess/cassandra-loader/releases/download/v0.0.19/cassandra-loader

Get it with wget:

```
wget https://github.com/brianmhess/cassandra-loader/releases/download/v0.0.19/cassandra-loader
```
